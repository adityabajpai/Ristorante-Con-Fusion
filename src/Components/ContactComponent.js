                        ...
                        <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" placeholder="Enter your LastName" />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" placeholder="Enter your Tel. Number" />
                                </Col>
                            </Row>
                            <Row className="form-group">
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{size:3, offset:1}}>
                                    <Control.select model=".contactType" name="contactype" className="form-control">
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Control.select>
                                </Col>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".msg" id="message" name="message" placeholder="Enter your message"
